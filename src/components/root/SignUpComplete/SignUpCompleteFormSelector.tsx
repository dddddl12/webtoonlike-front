...
export default function SignUpCompleteFormSelector ({ clerkUserFullName }: {
  clerkUserFullName: string;
}) {
  const router = useRouter();
  const [signUpStage, setSignUpStage] = useState<SignUpStage>(SignUpStage.Begin);
